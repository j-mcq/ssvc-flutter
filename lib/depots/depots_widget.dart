...
import 'depots_model.dart';
export 'depots_model.dart';

class DepotsWidget extends StatefulWidget {
  const DepotsWidget({Key? key}) : super(key: key);

  @override
  _DepotsWidgetState createState() => _DepotsWidgetState();
}

class _DepotsWidgetState extends State<DepotsWidget> {
  late DepotsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DepotsModel());
                                      ...
                                      child: StreamBuilder<List<DepotsRecord>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemCount:
                                                listViewDepotsRecordList.length,
                                            itemBuilder:
                                                                  ...
                                                                  children: [
                                                                    Expanded(
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          AutoSizeText(
                                                                            listViewDepotsRecord.name != null && listViewDepotsRecord.name != ''
                                                                                ? listViewDepotsRecord.name
                                                                                : ''.maybeHandleOverflow(
                                                                                    maxChars: 32,
                                                                                    replacement: '…',
                                                                                  ),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            if (confirmDialogResponse) {
                                                                              await listViewDepotsRecord.reference.delete();
                                                                            }
                                                                          },
                                                                          child:
                                                                              Icon(
