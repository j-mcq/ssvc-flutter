...
class AddActiveResponseItemModel extends FlutterFlowModel {
  ///  State fields for stateful widgets in this component.

  final formKey = GlobalKey<FormState>();
  // State field(s) for resonseItemType widget.
  String? resonseItemTypeValue;
  FormFieldController<String>? resonseItemTypeValueController;
