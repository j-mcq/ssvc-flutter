...
import 'scenario_copy_model.dart';
export 'scenario_copy_model.dart';

class ScenarioCopyWidget extends StatefulWidget {
  const ScenarioCopyWidget({Key? key}) : super(key: key);

  @override
  _ScenarioCopyWidgetState createState() => _ScenarioCopyWidgetState();
}

class _ScenarioCopyWidgetState extends State<ScenarioCopyWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScenarioCopyModel());
