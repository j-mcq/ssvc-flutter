...
class _ScenarioWidgetState extends State<ScenarioWidget> {
  ...
  void initState() {
    ...
    _model.searchAddressController ??= TextEditingController();
                                                                      ...
                                                                      children: [
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              TextFormField(
                                                                            controller:
                                                                                _model.searchAddressController,
                                                                            obscureText:
                                                                                false,
                                                                            decoration:
                                                                                InputDecoration(
                                                                            ...
                                                                            style:
                                                                                FlutterFlowTheme.of(context).bodyMedium,
                                                                            validator:
                                                                                _model.searchAddressControllerValidator.asValidator(context),
                                                                          ),
                                                                        ),
                                                                      ],
                                                                    ),
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: StreamBuilder<
                                                              ...
                                                              stream:
                                                                ...
                                                                parent: widget
                                                                    .scenarioReference,
                                                                queryBuilder: (scenarioHouseholdResponsesRecord) =>
                                                                    scenarioHouseholdResponsesRecord.orderBy(
