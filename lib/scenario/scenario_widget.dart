                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                FFButtonWidget(
                                                  onPressed: () async {
                                                    setState(() {
                                                      _model.isCircle = false;
                                                      _model.isPolygon = true;
                                                      _model.radius = null;
                                                    });
                                                  },
                                                  text: 'Add Polygon',
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        'Summary of the households that should be responded to first',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyText2,
                                  ...
                                  Padding(
                                    ...
                                    child: StreamBuilder<
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<ScenarioResultsCustomersRecord>
                                            listViewScenarioResultsCustomersRecordList =
                                            snapshot.data!;
                                        return ListView.builder(
                                          ...
                                          itemBuilder:
                                            ...
                                            final listViewScenarioResultsCustomersRecord =
                                                listViewScenarioResultsCustomersRecordList[
                                                    listViewIndex];
                                            return Padding(
                                              padding: EdgeInsetsDirectional
