...
class ScenariosWidget extends StatefulWidget {
  const ScenariosWidget({Key? key}) : super(key: key);

  @override
  _ScenariosWidgetState createState() => _ScenariosWidgetState();
}
                                                              ...
                                                              children: [
                                                                ...
                                                                if (responsiveVisibility(
                                                                  ...
                                                                  Expanded(
                                                                    flex: 1,
                                                                    child: Text(
                                                                      '${listViewScenarioRecord.outageDuration != null ? listViewScenarioRecord.outageDuration.toString() : ''} Hour(s)',
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium,
                                                                    ),
