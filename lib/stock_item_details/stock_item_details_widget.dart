...
class StockItemDetailsWidget extends StatefulWidget {
  const StockItemDetailsWidget({
    Key? key,
    this.responseItemReference,
  }) : super(key: key);
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: StreamBuilder<ResponseItemsRecord>(
                          stream: ResponseItemsRecord.getDocument(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final clipContainerResponseItemsRecord =
                                snapshot.data!;
                            return Container(
                              width: double.infinity,
                              decoration: BoxDecoration(
