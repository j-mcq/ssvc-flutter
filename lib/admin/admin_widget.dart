                                                            ...
                                                            child:
                                                              ...
                                                              onPressed:
                                                                ...
                                                                var confirmDialogResponse =
                                                                    await showDialog<
                                                                          ...
                                                                          builder:
                                                                              (alertDialogContext) {
                                                                            return AlertDialog(
                                                                              title: Text('Delete All PSR Records'),
                                                                              content: Text('Are you sure you want to delete all existing PSR Records.'),
                                                                              actions: [
                                                                                TextButton(
                                                                ...
                                                                if (confirmDialogResponse) {
                                                                  _model.outDeleteAllPsrCustomers =
                                                                      await actions
                                                                          .deleteAllPsrCustomers();
                                                                  if (_model
                                                                      .outDeleteAllPsrCustomers!) {
                                                                    ScaffoldMessenger.of(
                                                                            context)
                                                                        .showSnackBar(
                                                                      SnackBar(
                                                                    ...
                                                                    ScaffoldMessenger.of(
                                                                      ...
                                                                      SnackBar(
                                                                        content:
                                                                            Text(
                                                                          'There was a problem with removing all records',
                                                                ...
                                                                var confirmDialogResponse =
                                                                    await showDialog<
                                                                          ...
                                                                          builder:
                                                                              (alertDialogContext) {
                                                                            return AlertDialog(
                                                                              title: Text('Delete All Response Items'),
                                                                              content: Text('Are you sure you want to delete all existing response items.'),
                                                                              actions: [
                                                                                TextButton(
                                                                                  onPressed: () => Navigator.pop(alertDialogContext, false),
                                                                                  child: Text('Cancel'),
                                                                        ...
                                                                        false;
                                                                if (confirmDialogResponse) {
                                                                  _model.outDeleteAllPsrActiveResponseItems =
                                                                      await actions
                                                                          .deleteAllActiveResponseItems();
                                                                  if (_model
                                                                      .outDeleteAllPsrActiveResponseItems!) {
                                                                    ScaffoldMessenger.of(
                                                                            context)
                                                                        .showSnackBar(
                                                                      SnackBar(
